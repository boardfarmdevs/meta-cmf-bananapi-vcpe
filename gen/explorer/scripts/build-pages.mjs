...
const worlds = path.join(repository, 'gen/wmediumd/configurator/worlds');
...
const publicViewer = viewer.replace(
  ...
  '<title>RDK EasyMesh — Room sandbox</title>',
);
...
writeFileSync(
  ...
  JSON.stringify(
    {
      repository: 'boardfarmdevs/meta-cmf-bananapi-vcpe',
